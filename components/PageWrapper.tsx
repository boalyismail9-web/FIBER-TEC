...
const PageWrapper: React.FC<PageWrapperProps> = ({ title, onBack, children }) => {
  return (
    <div className="min-h-screen bg-gray-50 animate-fade-in">
      <header className={`sticky top-0 z-10 flex items-center ${onBack ? 'justify-between' : 'justify-end'} border-b border-gray-200 bg-gray-50/95 p-4 backdrop-blur-sm sm:p-6 md:p-8`}>
